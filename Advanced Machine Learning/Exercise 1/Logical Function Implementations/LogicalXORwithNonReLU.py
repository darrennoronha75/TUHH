...
# Define Abs activation function
def Abs(x):
    return np.abs(x)

# Define the input matrix for XOR Logical Function
...
# Apply the abs activation function to output of the first layer
activation1 = Abs(out1)
print(activation1)