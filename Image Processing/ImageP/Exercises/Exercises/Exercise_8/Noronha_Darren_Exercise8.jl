...
md"
Another important ingredient for driving assitance is recognizing traffic lights. In this exercise we want to use an 'old', non-AI ansatz to solve this problem.
###### 🎓 b)
